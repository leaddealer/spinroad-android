...
public class ItemSelfiestick extends Item {
    ...
    public ItemSelfiestick(int screenWidth, int screenHeight) {
        super(screenWidth, screenHeight);
        itemImage = new TextureRegion(new Texture("selfiestick.png"));
